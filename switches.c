/*
*	Modified version of the switches file included in Phill Raynsford's FortunaTetris
*	Edited to include hold methods for every direction rather than just down.
*/
#include "switches.h"
#include <avr/io.h>
